...
<section id="hero" class="hero">
  ...
  <div class="row g-3">
    ...
    <div class="col-md-6">
      <button type="button" class="btn btn-projects w-100" onclick="openPDFModal('assets/documents/CV_Atef.pdf', 'CV')">
        CV
      </button>
    </div>
  </div>
...
<section id="stages" class="section custom-border">
  <div class="container">
    ...
    <p class="text-center mb-4">
      Les cartes ci-dessous permettent de consulter les documents associés à chaque période de stage.
    </p>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-12 mb-4">
        <button
          ...
          data-i18n="[aria-label]aria.stage1Doc"
        >
          <div class="card-body">
            <h3>Stage 1 — Tanios Consulting</h3>
            <p class="text-muted">Saint-Denis • 09/06/2025 - 11/06/2025</p>
            <p>
              Ce premier stage m’a permis de découvrir le fonctionnement d’une entreprise de services numériques,
              d’observer son organisation interne et de mieux comprendre la relation entre les besoins clients
              et les solutions informatiques proposées.
            </p>
            <ul class="skill-list">
              <li><span>Découverte de l’organisation interne d’une entreprise de services numériques</span></li>
              <li><span>Observation des besoins clients, des méthodes de travail et des outils professionnels</span></li>
              <li><span>Mise en lien des compétences du BTS SIO avec un contexte d’entreprise réel</span></li>
            </ul>
          </div>
        </button>
      </div>
      ...
      <div class="col-lg-6 col-md-12 mb-4">
        ...
        >
          <div class="card-body">
            ...
            <ul class="skill-list">
              <li><span>Approfondissement des pratiques professionnelles en environnement réel</span></li>
              <li><span>Participation à des missions de développement, de suivi applicatif et d’analyse des besoins</span></li>
              <li><span>Renforcement de l’autonomie, de la communication professionnelle et de la rigueur technique</span></li>
            </ul>
          </div>
        </button>
      </div>
...
<div id="pdfModal" class="custom-modal">
  <div class="custom-modal-content">
    ...
    <button type="button" class="close-btn" aria-label="Fermer" data-i18n="[aria-label]aria.close" onclick="closePDFModal()">&times;</button>
