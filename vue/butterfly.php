...
<main class="tuto-container">
  <div class="tuto-content">
    ...
    <ul class="sommaire">
      ...
      <li><a href="vue/butterfly.php#captures">10. Captures d’écran</a></li>
    </ul>
    ...
    <div class="row">
      ...
      <div class="col-md-3 mb-4">
        <figure class="capture-figure">
          <img src="assets/images/ButterFly/destinations.png" alt="Destinations ButterFly"
      ...
      <div class="col-md-3 mb-4">
        <figure class="capture-figure">
          <img src="assets/images/ButterFly/detailVoyage.png" alt="Détail d’un voyage ButterFly"
      ...
      <div class="col-md-3 mb-4">
        <figure class="capture-figure">
          <img src="assets/images/ButterFly/admin.png" alt="Administration ButterFly"
      ...
      <div class="col-md-3 mb-4">
        <figure class="capture-figure">
          <img src="assets/images/ButterFly/reservationsAdmin.png" alt="Gestion des réservations ButterFly"
    ...
    <div class="modal fade" id="modal2" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <img src="assets/images/ButterFly/destinations.png" class="img-fluid rounded" alt="Destinations ButterFly">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="modal3" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <img src="assets/images/ButterFly/detailVoyage.png" class="img-fluid rounded" alt="Détail voyage ButterFly">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="modal7" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <img src="assets/images/ButterFly/admin.png" class="img-fluid rounded" alt="Administration ButterFly">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="modal8" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <img src="assets/images/ButterFly/reservationsAdmin.png" class="img-fluid rounded" alt="Gestion des réservations ButterFly">
          </div>
        </div>
      </div>
    </div>
