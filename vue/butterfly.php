...
<main class="tuto-container">
  <div class="tuto-content">
    ...
    <h2>Sommaire</h2>
    <ul class="sommaire">
      <li><a href="vue/butterfly.php#objectif">1. Objectif du projet</a></li>
      <li><a href="vue/butterfly.php#contexte">2. Contexte</a></li>
      <li><a href="vue/butterfly.php#bdd">3. Base de données</a></li>
      <li><a href="vue/butterfly.php#architecture">4. Architecture et méthodes</a></li>
      <li><a href="vue/butterfly.php#fonctionnalites">5. Fonctionnalités</a></li>
      <li><a href="vue/butterfly.php#frontend">6. Front-end</a></li>
      <li><a href="vue/butterfly.php#backend">7. Back-end</a></li>
      <li><a href="vue/butterfly.php#difficultes">8. Difficultés rencontrées</a></li>
      <li><a href="vue/butterfly.php#ameliorations">9. Améliorations possibles</a></li>
      <li><a href="vue/butterfly.php#code">10. Code source</a></li>
      <li><a href="vue/butterfly.php#captures">11. Captures d’écran</a></li>
    </ul>
    ...
    <!-- 10. code source -->
    <h2 id="code">10. Code source</h2>
    <p>
      Le code source du projet est disponible sur GitHub :
      <a href="https://github.com/TON_COMPTE/TON_REPO" target="_blank" rel="noopener noreferrer">Voir le code source</a>
    </p>

    <!-- 11. captures -->
    <h2 id="captures">11. Captures d’écran</h2>
    <p>
      Voici quelques captures d’écran du projet afin d’illustrer son interface et certaines fonctionnalités.
    </p>

    <div class="row">
      <div class="col-md-3 mb-4">
        <figure>
          <img src="assets/images/BFLY/home.png" alt="Page d’accueil ButterFly"
               data-bs-toggle="modal" data-bs-target="#modal1"
               class="img-fluid rounded">
          <figcaption class="text-center mt-2">Accueil</figcaption>
        </figure>
      </div>

      <div class="col-md-3 mb-4">
        <figure>
          <img src="assets/images/BFLY/destinations.png" alt="Liste des destinations ButterFly"
               data-bs-toggle="modal" data-bs-target="#modal2"
               class="img-fluid rounded">
          <figcaption class="text-center mt-2">Destinations</figcaption>
        </figure>
      </div>

      <div class="col-md-3 mb-4">
        <figure>
          <img src="assets/images/BFLY/details.png" alt="Détail d’un voyage ButterFly"
               data-bs-toggle="modal" data-bs-target="#modal3"
               class="img-fluid rounded">
          <figcaption class="text-center mt-2">Détails</figcaption>
        </figure>
      </div>

      <div class="col-md-3 mb-4">
        <figure>
          <img src="assets/images/BFLY/admin.png" alt="Interface administrateur ButterFly"
               data-bs-toggle="modal" data-bs-target="#modal4"
               class="img-fluid rounded">
          <figcaption class="text-center mt-2">Administration</figcaption>
        </figure>
      </div>
    </div>
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <img src="assets/images/BFLY/home.png" class="img-fluid rounded" alt="Accueil ButterFly">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="modal2" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <img src="assets/images/BFLY/destinations.png" class="img-fluid rounded" alt="Destinations ButterFly">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="modal3" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <img src="assets/images/BFLY/details.png" class="img-fluid rounded" alt="Détails ButterFly">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="modal4" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            <img src="assets/images/BFLY/admin.png" class="img-fluid rounded" alt="Administration ButterFly">
          </div>
        </div>
      </div>
    </div>
