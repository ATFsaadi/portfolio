...
<main class="tuto-container">
  <div class="tuto-content">
    ...
    <h2>Sommaire</h2>
    <ul class="sommaire">
      <li><a href="#about">1. Présentation</a></li>
      <li><a href="#options">2. Les options</a></li>
      <li><a href="#exams">3. Examens</a></li>
      <li><a href="#career">4. Les débouchés</a></li>
    </ul>

    <!-- 1. présentation -->
    <h2 id="about">1. Présentation</h2>
    <p>
      Le BTS SIO (Services Informatiques aux Organisations) est une formation de deux ans
      qui permet de se spécialiser dans le développement web et la gestion des réseaux informatiques.
    </p>
    ...
    <div class="options">
      <div class="card p-3">
        ...
        <ul>
          <li>Développement de logiciels et applications</li>
          <li>Conception de sites web</li>
          <li>Métiers visés : Développeur, Analyste programmeur</li>
        </ul>
      </div>
      ...
      <div class="card p-3">
        ...
        <ul>
          <li>Mise en place et gestion des réseaux informatiques</li>
          <li>Maintenance des infrastructures</li>
          <li>Métiers visés : Administrateur réseaux, Technicien systèmes</li>
        </ul>
      </div>
    </div>
    ...
    <p>Après le BTS SIO, plusieurs métiers sont accessibles selon l’option choisie :</p>
    ...
    <div class="debouches">
      <div class="card p-3">
        ...
        <ul>
          ...
          <li>Gestionnaire du parc informatique</li>
          <li>Analyste d’exploitation informatique</li>
          <li>Technicien des réseaux de télécommunications</li>
