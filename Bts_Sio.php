...
<main class="tuto-container">
    <div class="tuto-content">
        ...
        <ul class="sommaire">
            <li>
                <a href="#about">1. Présentation</a>
            </li>
            <li>
                <a href="#options">2. Les options</a>
            </li>
            <li>
                <a href="#exams">3. Examens</a>
            </li>
            <li>
                <a href="#career">4. Les débouchés</a>
            </li>
        </ul>
        ...
        <p>
            ...
            est une formation de deux ans qui permet de se spécialiser dans le développement
            web et la gestion des réseaux informatiques.
        </p>
